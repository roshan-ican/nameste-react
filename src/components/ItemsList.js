...
const ItemsList = ({ items, categoryName, renderCustomHeader }) => {
    ...
    return (
        <div className="mb-6 border-b">
            {/* Category Header - can be customized or use default */}
            {renderCustomHeader ? (
                renderCustomHeader(categoryName)
            ) : (
                <div className="w-full text-left py-4 flex justify-between items-center text-red-600 text-2xl font-semibold border border-red-500 shadow-lg">
                    <p className="text-2xl mx-2">{categoryName}</p>
                </div>
            )}
